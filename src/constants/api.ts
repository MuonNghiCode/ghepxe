...
export const API_BASE_URL = process.env.NEXT_PUBLIC_BASE_URL || "http://localhost:2406/";
...
export const API_ENDPOINTS = {
  ...
  SHIP_REQUEST: {
    ...
    GET_PRICE: "/api/User/ShipRequest/{shipRequestId}/price",
  },
  ROUTE_REQUEST: {
    CREATE: "/api/Driver/RouteRequest",
    GET: "/api/Driver/RouteRequest",
    GET_DETAIL: "/api/Driver/RouteRequest/{routeRequestId}",
    GET_ALL: "/api/Driver/RouteRequest/admin/all",
