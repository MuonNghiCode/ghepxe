          ...
          <div>
            ...
            <div className="space-y-4 mb-8">
              <div className="flex items-start gap-3">
                ...
                <p className="text-[var(--gray-text)]">CCCD (mặt trước & sau)</p>
              </div>
              
              <div className="flex items-start gap-3">
                <div className="w-2 h-2 bg-[var(--ghepxe-green)] rounded-full mt-2 flex-shrink-0"></div>
                <p className="text-[var(--gray-text)]">Cà vẹt xe (Giấy đăng ký phương tiện)</p>
              </div>
              
              <div className="flex items-start gap-3">
                <div className="w-2 h-2 bg-[var(--ghepxe-green)] rounded-full mt-2 flex-shrink-0"></div>
                <p className="text-[var(--gray-text)]">Giấy phép lái xe phù hợp với loại xe đăng ký</p>
              </div>
              ...
              <div className="flex items-start gap-3">
                <div className="w-2 h-2 bg-[var(--ghepxe-green)] rounded-full mt-2 flex-shrink-0"></div>
                <p className="text-[var(--gray-text)]">Tuyến đường thường chạy</p>
              </div>
              
              <div className="flex items-start gap-3">
                <div className="w-2 h-2 bg-[var(--ghepxe-green)] rounded-full mt-2 flex-shrink-0"></div>
                <p className="text-[var(--gray-text)]">Số điện thoại để nhận mã OTP đăng ký</p>
              </div>
            </div>
