...
const featuresEn: Feature[] = [
  {
    ...
    description: "We work with autonomy, flexibility, and creativity.",
  },
  {
    id: 2,
    icon: (
    ...
    description:
      "We constantly upgrade our system to ensure the best experience.",
  },
  {
    id: 3,
    icon: (
    ...
    description: "We always accompany and support businesses on every journey.",
  },
];
...
const texts = {
  vi: {
    ...
    desc1:
      "GhepXe giúp doanh nghiệp đơn giản hóa quy trình vận chuyển bằng cách ứng dụng công nghệ thông minh để ghép đơn, tối ưu lộ trình và rút ngắn thời gian giao nhận",
    desc2:
      "Chúng tôi cam kết minh bạch, hiệu quả và đồng hành cùng doanh nghiệp trong từng chặng đường phát triển, từ vận chuyển nội thành đến liên tỉnh",
  },
  en: {
    title: (
      <>
        <span className="whitespace-nowrap">GhepXe Platform</span>{" "}
        <span className="text-[var(--primary-green)]">for Business</span>
      </>
    ),
    desc1:
      "GhepXe helps businesses simplify transportation processes by applying smart technology to merge orders, optimize routes, and shorten delivery times.",
    desc2:
      "We commit to transparency, efficiency, and accompany businesses in every stage of growth, from local to interprovincial delivery.",
  },
};
